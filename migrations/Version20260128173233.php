 ...
 */
final class Version20260128173233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dishes (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price DOUBLE PRECISION NOT NULL, is_available TINYINT NOT NULL, menu_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_584DD35DCCD7E912 (menu_id), INDEX IDX_584DD35D12469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE dishes ADD CONSTRAINT FK_584DD35DCCD7E912 FOREIGN KEY (menu_id) REFERENCES menus (id)');
